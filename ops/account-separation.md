...
Release run [35390940684](https://github.com/tryjesusmedia/tryjesusjourney/actions/runs/35390940684) completed successfully, including the clean install, typecheck, lint, tests, callback/isolation checks, and native signing. Artifact `bible-and-conflict-android-6-lion-lamb-icon` (ID `10566701269`) expires October 2, 2026. ZIP SHA-256: `743d8b4b2dd2844b2c793f06761ca5375f3951914d89b42cb391d29e1c7f5164`. AAB SHA-256: `bb7a753b17e9e91115c29d771a473126157e176b774de28fbd68ba57b7b54ce7` (82,032,318 bytes). Archive CRCs and signature entries were checked. The launcher foreground extracted from the finished bundle was visually verified against the supplied image. The build workflow skipped Google Play submission; the owner subsequently authorized publishing, and the signed bundle was uploaded and submitted through Google Play Console as recorded below.

**Earlier Android build 5 and build 4 bundles are superseded and lack the newly supplied icon. Do not upload them for this release.** Production was verified at 1.0.1 / build 2 before submission on September 18. After the owner renewed publishing authorization, build 6 was uploaded successfully through the browser. Release 3, `1.0.5 — New icon, reading badges and sync`, was saved at 100% rollout to all existing targeted countries and submitted for review. [Publishing overview](https://play.google.com/console/u/1/developers/5712654634415606173/app/4976442224378840807/publishing) confirmed **Changes in review**, with quick checks running and **Managed publishing off**. The update will publish automatically after Google approval. Public availability is not yet verified; do not upload or submit a duplicate.

Play validation reported no blocking errors and no loss of supported devices. Its one nonblocking warning concerned a missing deobfuscation mapping file. The approved release includes the launcher icon; no separate store-listing artwork was changed.
