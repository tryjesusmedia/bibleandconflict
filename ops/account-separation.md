...
Status on 2026-09-18: **website separation and the FaithCraft reading-completion update are live; the replacement Android bundle is signed; Google Play upload is blocked**. Website PR #36 deployed successfully as `80b2cb38131f453adc76ffa46fbb04a60e0a466a`. Google provider and return URLs were saved by the owner, and OAuth reaches Google's account chooser. Final signed-in callback and installed-app checks still need completion.

The current release source is app commit `14f183fc3532f3127dec634a183e50ae6e4061f3`, including PR #3: simpler Bible-reading labels, no pending reminder, and a teal/gold/white completion card shown only after all reading items are complete. Matching website rendering and app progress/sync checks passed; text contrast is 7.05:1. Replacement [release run 35378323553](https://github.com/tryjesusmedia/tryjesusjourney/actions/runs/35378323553) passed every source gate and successfully signed Android 1.0.3 / build 4. Artifact `bible-and-conflict-android-4-reading-complete` (ID `10561809470`) expires October 2, 2026. ZIP SHA-256: `acb8c1817e0664d7dea604aa150b450a7e89bfdc92d55396a8345381f0353b08`. AAB SHA-256: `1ca714957622fc850c87dca882aeb382b60a1be129c8771c50b7662b6fd3794c`. Archive CRCs and the bundle signature entries were checked.

**The earlier bundle from run 35373377612 (artifact 10560106175) is superseded. Do not upload it:** it lacks the owner's requested completion-screen changes. Its EAS submission never reached Google Play because no Play service-account credential is configured. Production was verified at 1.0.1 / build 2 on September 18. The replacement upload through the authorized Play Console session was denied by browser permission policy. No bundle was uploaded and no Google Play review was started. Do not retry the denied upload through another route without renewed authorization. Production draft release 3 contains the prepared name and release notes; the owner can upload the replacement AAB there manually. Automatic EAS submission is opt-in and was skipped for this build.
